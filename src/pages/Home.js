      ...
      <section className="hero">
        <div className="text-content">
          ...
          <div className='link-to'>
            ...
            <a href='https://x.com/Aninwa_undies'> <img src='images/twitter1.png' alt='twitter' width={20} height={20}></img></a>
            <a href='https://web.facebook.com/Eminel55555'> <img src='images/facebook.png' alt='facebook' width={20} height={20}></img></a>
            <a href='mailto:anisimon755@gmail.com'><img src='images/message.png' alt="email" width={20} height={20}></img></a>
          </div>
          <div className="buttons">
            <a href='https://wa.me/+2347034418309' className="btn primary">Hire Me</a>
            <button onClick={goToLogin} className="btn secondary2">Resume</button>
          </div>
        </div>
      ...
      <section className="projects" id="works">
        ...
        <div className="projects-grid">
            <div className="project-card">
              <img src="images/work1.png" alt="clothing Website" class="default-img"></img>
            ...
            <div class="project-card">
              ...
              <img src="images/work9.png" alt="resturant Website Hover" class="hover-img" />
              <h3>Resturant Website</h3>
              <p>A Resturant website where individuals can place order on foods and drinks and get them deliver to them, equally book for a space.</p>
              <a href='https://github.com/ASC-cm'>View Project codes</a>
            </div>
            <div class="project-card">
              <img src="images/work2.png" alt="Tech Website" class="default-img" />
              <img src="images/work6.png" alt="Tech Website Hover" class="hover-img" />
              <h3>E-learning Tech Website</h3>
              <p>An Technology website, where you can undergo both online/offline tech courses.</p>
              <a href='https://github.com/ASC-cm'>View Project codes</a>
            </div>
            <div class="project-card">
            ...
            <div class="project-card">
              <img src="https://via.placeholder.com/150" alt="Photography Website" class="default-img" />
              <img src="https://via.placeholder.com/150/00FFFF" alt="Photography Website Hover" class="hover-img" />
      ...
      <section className="timeline">
          ...
          <div className="timeline-container">
            <div className="timeline-item timeline-right" data-aos="fade-right">
              ...
              <p>Full-stack Web Development. Focused on building responsive web applications/website.</p>
            </div>
            <div className="timeline-item timeline-left" data-aos="fade-left">
              ...
              <p>Serving our Father land, where i gain knowledge of what Programming is all about.</p>
            </div>
            <div className="timeline-item timeline-right" data-aos="fade-right">
              <h3>Skillup Training Academy (STA)</h3>
              <p>Sept 2017 - Dec 2017</p>
              <p>Training people to achieve greatness, Career and Entrepreneurship Development.</p>
            </div>
            <div className="timeline-item timeline-left" data-aos="fade-left">
              <h3>Career Link And Skill Acquisition Company</h3>
              <p>Sept 2015 - March 2016</p>
              <p>Certificate of Excellence with a focus on Information Technology and Internet opportunities.</p>
            </div>
          </div>
          <button onClick={goToLogin} className="btn secondary">View more</button>
      </section>
    </>
  )
}
